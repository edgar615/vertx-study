 ...
 */
public class DefaultMessageCodecServer {
  public static void main(String[] args) {
    Vertx vertx = Vertx.vertx();
    EventBus eb = vertx.eventBus();

    MyCodec myCodec = new MyCodec();
    eb.registerDefaultCodec(MyPojo.class, myCodec);
    ...
    // .sport.
    eb.send("news.uk.sport", new MyPojo("Yay! Someone kicked a ball"));
    eb.send("news.uk.sport", new MyPojo("2Yay! Someone kicked a ball"));
    eb.send("news.uk.sport", new MyPojo("3Yay! Someone kicked a ball"));
